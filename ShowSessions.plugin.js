...
function buildPlugin([BasePlugin, PluginApi]) {
	...
	(() => {
		...
		(() => {
			...
			if (AvatarDefaults?.BOT_AVATARS && !AvatarDefaults.BOT_AVATARS.betterdiscord) AvatarDefaults.BOT_AVATARS.betterdiscord = "https://cdn.discordapp.com/attachments/796403782568378389/867033619000066048/unnamed_1.jpg";
			...
			if (!DiscordCommands.BUILT_IN_SECTIONS.some((e => "betterdiscord" === e.id))) DiscordCommands.BUILT_IN_SECTIONS.push({
				icon: "https://cdn.discordapp.com/attachments/796403782568378389/867033619000066048/unnamed_1.jpg",
				id: "betterdiscord",
				name: "BetterDiscord",
				type: 0
			});
